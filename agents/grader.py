...
class Grader:
    ...
    def grade(self, rubric_component: str, student_response: str, grader_argument: str=None):
        message = [
          {"role": "system",
          "content": f"You are a biology grading assistant. Your task is to evaluate student responses{', as well as arguments from another grading assistant, ' if grader_argument else ' '}to determine if the rubric component is satisfied. You will provide your evaluation in JSON format."},
          {"role": "user",
          "content": f"""
